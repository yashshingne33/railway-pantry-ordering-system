...
/* Indian Railways coach layout:
   Each coach has berths: Lower(L), Middle(M), Upper(U), Side Lower(SL), Side Upper(SU)
   Compartments: 1–9 (8 berths each) + side berths
*/
export const COACH_LAYOUT = {
  // Sleeper / 3AC / 2AC: 8 berths per bay × 9 bays + 8 side berths = 80 berths total
  // Simplified: 72 numbered seats in 9 bays
  bays: 9,
  berths: ['L','M','U','L','M','U','SL','SU'], // per bay: 6 main + 2 side
  seatTypes: {
...
// Generate all 72 seats for a coach with their berth type
...
/* ══════════════════════════════════════════════════════════════
   GLOBAL STYLES (injected once from root)
══════════════════════════════════════════════════════════════ */
